...
- `evals/trigger-positive.jsonl` and `evals/trigger-negative.jsonl` (routing tests)
- `evals/behavior.jsonl` (output format/behavior validation tests)
- `evals/baseline-cases.jsonl` (before/after comparison tests)
